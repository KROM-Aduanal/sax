...
#Region "Attributes"
        ...
        'Configuración
        Private _guardarReporte As Boolean

        Private _cerrarReporte As Boolean

        Private _visualizarReporte As Boolean
...
#Region "Builders"
        ...
        Sub New()
            ...
            _guardarReporte = False

            _cerrarReporte = False

            _visualizarReporte = True
...
#Region "Properties"
        ...
        Public Property GuardarReporte As Boolean

            Get

                Return _guardarReporte

            End Get

            Set(ByVal value As Boolean)

                _guardarReporte = value

            End Set

        End Property

        Public Property CerrarReporte As Boolean

            Get

                Return _cerrarReporte

            End Get

            Set(ByVal value As Boolean)

                _cerrarReporte = value
        ...
        Public Property VisualizarReporte() As Boolean

            Get

                Return _visualizarReporte

            End Get

            Set(ByVal value As Boolean)

                _visualizarReporte = value
...
#Region "Methods"
        ...
        Public Sub CreateReport()
            ...
            Try
                ...
                Select Case _makermode
                    ...
                    Case IReportw.MakerModes.ThroughCollections
                        ...
                        If Not objWokSheet1_ Is Nothing Then
                            ...
                            ' 28/07/2020 - JC - Se agrega la propiedad guardarReporte para no interferir con el funcionamiento de la clase
                            'If _pathsavefile <> "" Then
                            If _guardarReporte Then

                                ' 28/07/2020 - JC - esta linea estaba comentada apesar de mandar la ruta para guardar
                                '_objExcelBook.SaveAs(_pathsavefile, Excel.XlFileFormat.xlWorkbookDefault)

                                _objExcelBook.SaveAs(_pathsavefile,
                ...
                If Not _excelapplication Is Nothing Then
                    ...
                    _excelapplication.Visible = _visualizarReporte
            ...
            Finally
                ...
                If _cerrarReporte Then

                    If Not _objExcelBook Is Nothing Then

                        _objExcelBook.Close(False)

                        _objExcelBook = Nothing
        ...
        Public Sub CreateReportCSV()
            ...
            Try
                ...
                If _sistema.TieneResultados(_ioperationscatalog) Then
                    ...
                    _objCSVReport.Append(_ioperationscatalog.Nombre. _
                                                Replace(",", " "). _
                                                Replace("á", "a"). _
                                                Replace("é", "e"). _
                                                Replace("í", "i"). _
 ...
 _
                    ...
                    _objCSVReport.Append(_subtitle. _
                                                Replace(",", " "). _
                                                Replace("á", "a"). _
                                                Replace("é", "e"). _
                                                Replace("í", "i"). _
 ...
 _
                    ...
                    _objCSVReport.Append("Date:" & Now().ToString & "  Company:" & companyName_. _
                                                Replace(",", " "). _
                                                Replace("á", "a"). _
                                                Replace("é", "e"). _
                                                Replace("í", "i"). _
 ...
 _
                    ...
                    For Each column_ As DataColumn In _ioperationscatalog.Vista.Tables(0).Columns
                        ...
                        _objCSVReport.Append(column_.ColumnName. _
                                                Replace(",", " "). _
                                                Replace("á", "a"). _
                                                Replace("é", "e"). _
                                                Replace("í", "i"). _
 ...
 _
                    ...
                    For Each row_ As DataRow In _ioperationscatalog.Vista.Tables(0).Rows
                        ...
                        For i_ As Integer = 0 To _ioperationscatalog.Vista.Tables(0).Columns.Count - 1
                            ...
                            _objCSVReport.Append(row_(i_). _
                                                ToString(). _
                                                Replace(",", " "). _
                                                Replace("á", "a"). _
                                                Replace("é", "e"). _
