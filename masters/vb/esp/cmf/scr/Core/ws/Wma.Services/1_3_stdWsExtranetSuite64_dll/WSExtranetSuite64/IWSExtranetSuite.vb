...
<ServiceContract()>
    <XmlSerializerFormat>
Public Interface IWSExtranetSuite
...
#Region "Properties"
    ...
    '<ServiceKnownType(GetType(XMLSchemaObject2))>
...
<ServiceKnownType(GetType(CustomSections))>
 ...
 _
                                        Optional ByVal DisplayData As WSExtranetSuite.TypesDisplay = WSExtranetSuite.TypesDisplay.ShowAll) As XMLSchemaObject
...
#Region "Attributes"
    ...
    Private _operationType As WSExtranetSuite.OperationTypes

    Private _managementCompanyId As IWSExtranetSuite.ManagementCompanies
    ...
    Private _customSection As WSExtranetSuite.CustomSections
...
#Region "Builders"
    ...
    Sub New()
        ...
        _operationType = WSExtranetSuite.OperationTypes.UND

        _managementCompanyId = IWSExtranetSuite.ManagementCompanies.UND
        ...
        _customSection = WSExtranetSuite.CustomSections.UND
...
#Region "Properties"
    ...
    '<DataMember, XmlAttribute>
    <DataMember>
    <XmlAttribute(AttributeName:="RefereceDate")> _
    ...
    <DataMember>
    <XmlAttribute(AttributeName:="VesselName")> _
