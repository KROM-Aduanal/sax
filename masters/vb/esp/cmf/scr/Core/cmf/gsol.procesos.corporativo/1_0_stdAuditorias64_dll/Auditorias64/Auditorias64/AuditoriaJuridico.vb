...
Public Class AuditoriaJuridico
...
#Region "Metodos Publicos"
    ...
    Public Function GuardarInformacion(ByVal ioperacionescatalogo_ As IOperacionesCatalogo, _
        ...
        InformacionTrafico_ = ConsultaInformacionTrafico(ioperacionescatalogo_, i_Cve_Referencia, i_Cve_Sistema, "VistoBuenoJuridicoTrafico")
    ...
    Public Function CancelaAuditoria(ByVal ioperacionescatalogo_ As IOperacionesCatalogo, _
        ...
        operacionesAux_ = _sistema.EnsamblaModulo("VistoBuenoJuridicoInfoAlmacenada")
    ...
    Public Function ExisteAuditoria(ByVal ioperacionescatalogo_ As IOperacionesCatalogo, _
        ...
        claususalSQL_ = " and t_NombreCorto = 'VBJ'" & _
            " and i_Cve_idReferencia = " & i_Cve_Referencia & _
            " and i_Cve_SistemaTrafico = " & i_Cve_Sistema & _
            " and i_Cve_Estatus = 1"

        ioperacionesLocal_ = _sistema.ConsultaModulo(ioperacionescatalogo_.EspacioTrabajo, "VistoBuenoJuridicoInfoAlmacenada", claususalSQL_)
...
#Region "Metodos privados"
    ...
    Private Function GuardarInformacion(ByVal ioperacionescatalogo_ As IOperacionesCatalogo, _
        ...
        operacionesAux_.CampoPorNombre("t_FormaPago") = datos_.Vista(0, "FormaPago", IOperacionesCatalogo.TiposAccesoCampo.NombreTecnico)

        'Se agregan estos campos para cuota compensatoria
        operacionesAux_.CampoPorNombre("i_CC") = datos_.Vista(0, "CC", IOperacionesCatalogo.TiposAccesoCampo.NombreTecnico)

        operacionesAux_.CampoPorNombre("t_Fraccion") = datos_.Vista(0, "FraccionContribucion", IOperacionesCatalogo.TiposAccesoCampo.NombreTecnico)
        'Se agregan estos campos para cuota compensatoria

        operacionesAux_.CampoPorNombre("t_PermisosFraccion") = datos_.Vista(0, "PermisosPar", IOperacionesCatalogo.TiposAccesoCampo.NombreTecnico)

        operacionesAux_.CampoPorNombre("t_IdentificadorComplementoPedimento") = datos_.Vista(0, "IdentificadoresPed", IOperacionesCatalogo.TiposAccesoCampo.NombreTecnico)

        operacionesAux_.CampoPorNombre("t_IdentificadorComplementoFraccion") = datos_.Vista(0, "IdentificadoresPar", IOperacionesCatalogo.TiposAccesoCampo.NombreTecnico)

        operacionesAux_.CampoPorNombre("i_Cve_CatalogoAuditoria") = objAdministracionAuditoria_.ConsultaClaveAuditoriaDesdeNombreCorto(ioperacionescatalogo_, "VBJ")
