            ...
            Select Case idSeccion_
                ...
                Case SeccionesFacturaComercial.SFAC1
                    Return New List(Of Nodo) From {
                                            ...
                                            Item(CamposFacturaComercial.CP_TIPO_CARGA_DATOS, Entero, useAsMetadata_:=True),
                                            Item(CamposFacturaComercial.CA_NUMERO_FACTURA, Texto, longitud_:=40, useAsMetadata_:=True),
                                            Item(CamposAcuseValor.CA_NUMERO_ACUSEVALOR, Texto, longitud_:=40, useAsMetadata_:=True),
                                            Item(CamposFacturaComercial.CA_FECHA_FACTURA, Fecha),
                                            Item(CamposAcuseValor.CA_FECHA_ACUSEVALOR, Fecha),
                                            Item(CamposFacturaComercial.CP_SERIE_FOLIO_FACTURA, Texto, useAsMetadata_:=True),
                                            Item(CamposClientes.CP_OBJECTID_CLIENTE, Texto), 'Agregarlo en el cliente
                                            Item(CamposClientes.CA_RAZON_SOCIAL, Texto, longitud_:=120),
                                            Item(CamposClientes.CP_CVE_CLIENTE, Entero), 'Agregarlo en el cliente
                                            ...
                                            Item(CamposFacturaComercial.CA_CVE_INCOTERM, Texto, useAsMetadata_:=True),
                                            ...
                                            Item(CamposFacturaComercial.CA_APLICA_SUBDIVISION, Booleano) ' Preguntar que significa el siguiente paramentro en los Enteros
                                          }
                    ' Datos del proveedor
                ...
                Case SeccionesFacturaComercial.SFAC3
                    Return New List(Of Nodo) From {
                           ...
                           Item(CamposDestinatario.CP_ID_DESTINATARIO, Texto),
