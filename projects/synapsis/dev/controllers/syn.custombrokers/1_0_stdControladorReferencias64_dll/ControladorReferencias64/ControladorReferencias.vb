...
Public Class ControladorReferencias
    ...
    Public Function CrearPrereferencias(documento_ As List(Of MemoryStream), Optional ByVal documetoCargado As IControllerChatGPT.DocumentoCargado = IControllerChatGPT.DocumentoCargado.BL) As TagWatcher Implements IControladorReferencias.CrearPrereferencias

        If (documento_.Count > 0) Then

            _Estado = _transformer.DocumentAnalyzer(Of Referencia)(documento_, documetoCargado)
    ...
    Public Function CrearPrereferencia(documento_ As MemoryStream, Optional ByVal documetoCargado As IControllerChatGPT.DocumentoCargado = IControllerChatGPT.DocumentoCargado.BL) As TagWatcher Implements IControladorReferencias.CrearPrereferencia
        ...
        If (documento_ IsNot Nothing) Then
            ...
            _Estado = _transformer.DocumentAnalyzer(Of Object)(x, documetoCargado)
