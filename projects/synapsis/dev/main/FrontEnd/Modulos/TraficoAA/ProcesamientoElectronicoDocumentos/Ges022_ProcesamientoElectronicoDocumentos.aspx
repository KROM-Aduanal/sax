...
<asp:Content runat="server" ID="Content4" ContentPlaceHolderID="contentBody">
        <GWC:FormControl runat="server" ID="__SYSTEM_MODULE_FORM" Label="<span style='color:#321761'>Procesamiento electrónico de</span><span style='color:#782360;'>&nbsp;documentos</span>" HasAutoSave="false">
             ...
             <Fieldsets>
                <GWC:FieldsetControl ID="fsDatosGenerales" runat="server" Label="Datos generales" Priority="true" CssClass="">
                    <ListControls> 
                             <asp:Panel runat="server" CssClass="col-12 col-md-1 col-lg-1 d-flex align-items-center flex-column margin-bottom"  ID="lbEstadoIntegracionCompleto" Visible="true" >
                                 <asp:Label runat="server" ID="lbEstadoCompletado" ToolTip="Completado" CssClass="cl_Num__Tarjeta estado_completado col-xs-12 col-md-12 col-lg-12" Text='<svg xmlns="http://www.w3.org/2000/svg" height="52" width="60" viewBox="0 0 640 512"><path fill="#fafcff" d="M320 0c17.7 0 32 14.3 32 32l0 64 120 0c39.8 0 72 32.2 72 72l0 272c0 39.8-32.2 72-72 72l-304 0c-39.8 0-72-32.2-72-72l0-272c0-39.8 32.2-72 72-72l120 0 0-64c0-17.7 14.3-32 32-32zM208 384c-8.8 0-16 7.2-16 16s7.2 16 16 16l32 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-32 0zm96 0c-8.8 0-16 7.2-16 16s7.2 16 16 16l32 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-32 0zm96 0c-8.8 0-16 7.2-16 16s7.2 16 16 16l32 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-32 0zM264 256a40 40 0 1 0 -80 0 40 40 0 1 0 80 0zm152 40a40 40 0 1 0 0-80 40 40 0 1 0 0 80zM48 224l16 0 0 192-16 0c-26.5 0-48-21.5-48-48l0-96c0-26.5 21.5-48 48-48zm544 0c26.5 0 48 21.5 48 48l0 96c0 26.5-21.5 48-48 48l-16 0 0-192 16 0z"/></svg>'></asp:Label>
                             </asp:Panel>
                           ...
                           <asp:Panel runat="server" CssClass="col-12 col-md-1 col-lg-1 d-flex align-items-center flex-column margin-bottom" ID="lbEstadoIntegracionCompleto2" Visible="False">
                               <asp:Label runat="server" ID="lbEstadoCompletado2" ToolTip="Completado" CssClass="cl_Num__Tarjeta estado_completado2 col-xs-12 col-md-12 col-lg-12" Text='<svg xmlns="http://www.w3.org/2000/svg" height="52" width="60" viewBox="0 0 640 512"><path fill="#fafcff" d="M320 0c17.7 0 32 14.3 32 32l0 64 120 0c39.8 0 72 32.2 72 72l0 272c0 39.8-32.2 72-72 72l-304 0c-39.8 0-72-32.2-72-72l0-272c0-39.8 32.2-72 72-72l120 0 0-64c0-17.7 14.3-32 32-32zM208 384c-8.8 0-16 7.2-16 16s7.2 16 16 16l32 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-32 0zm96 0c-8.8 0-16 7.2-16 16s7.2 16 16 16l32 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-32 0zm96 0c-8.8 0-16 7.2-16 16s7.2 16 16 16l32 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-32 0zM264 256a40 40 0 1 0 -80 0 40 40 0 1 0 80 0zm152 40a40 40 0 1 0 0-80 40 40 0 1 0 0 80zM48 224l16 0 0 192-16 0c-26.5 0-48-21.5-48-48l0-96c0-26.5 21.5-48 48-48zm544 0c26.5 0 48 21.5 48 48l0 96c0 26.5-21.5 48-48 48l-16 0 0-192 16 0z"/></svg>'></asp:Label>
                           </asp:Panel>
                              ...
                              <asp:Panel runat="server" CssClass="col-12 col-md-1 col-lg-1 d-flex align-items-center flex-column margin-bottom" ID="lbEstadoIntegracionConDetalles" Visible="False">
                                  <asp:Label runat="server" ID="lbEstadoDetalles" ToolTip="No completado" CssClass="cl_Num__Tarjeta estado_detalles col-xs-12 col-md-12 col-lg-12" Text='<svg xmlns="http://www.w3.org/2000/svg" height="52" width="60" viewBox="0 0 640 512"><path fill="#fafcff" d="M320 0c17.7 0 32 14.3 32 32l0 64 120 0c39.8 0 72 32.2 72 72l0 272c0 39.8-32.2 72-72 72l-304 0c-39.8 0-72-32.2-72-72l0-272c0-39.8 32.2-72 72-72l120 0 0-64c0-17.7 14.3-32 32-32zM208 384c-8.8 0-16 7.2-16 16s7.2 16 16 16l32 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-32 0zm96 0c-8.8 0-16 7.2-16 16s7.2 16 16 16l32 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-32 0zm96 0c-8.8 0-16 7.2-16 16s7.2 16 16 16l32 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-32 0zM264 256a40 40 0 1 0 -80 0 40 40 0 1 0 80 0zm152 40a40 40 0 1 0 0-80 40 40 0 1 0 0 80zM48 224l16 0 0 192-16 0c-26.5 0-48-21.5-48-48l0-96c0-26.5 21.5-48 48-48zm544 0c26.5 0 48 21.5 48 48l0 96c0 26.5-21.5 48-48 48l-16 0 0-192 16 0z"/></svg>'></asp:Label>
                              </asp:Panel>
                            ...
                            <asp:Panel runat="server" CssClass="col-12 col-md-1 col-lg-1 d-flex align-items-center flex-column margin-bottom" ID="lbEstadoIntegracionBorrador" Visible="False">
                                <asp:Label runat="server" ID="lbEstadoBorrador" ToolTip="Borrador" CssClass="cl_Num__Tarjeta estado_borrador col-xs-12 col-md-12 col-lg-12" Text='<svg xmlns="http://www.w3.org/2000/svg" height="52" width="60" viewBox="0 0 640 512"><path fill="#fafcff" d="M320 0c17.7 0 32 14.3 32 32l0 64 120 0c39.8 0 72 32.2 72 72l0 272c0 39.8-32.2 72-72 72l-304 0c-39.8 0-72-32.2-72-72l0-272c0-39.8 32.2-72 72-72l120 0 0-64c0-17.7 14.3-32 32-32zM208 384c-8.8 0-16 7.2-16 16s7.2 16 16 16l32 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-32 0zm96 0c-8.8 0-16 7.2-16 16s7.2 16 16 16l32 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-32 0zm96 0c-8.8 0-16 7.2-16 16s7.2 16 16 16l32 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-32 0zM264 256a40 40 0 1 0 -80 0 40 40 0 1 0 80 0zm152 40a40 40 0 1 0 0-80 40 40 0 1 0 0 80zM48 224l16 0 0 192-16 0c-26.5 0-48-21.5-48-48l0-96c0-26.5 21.5-48 48-48zm544 0c26.5 0 48 21.5 48 48l0 96c0 26.5-21.5 48-48 48l-16 0 0-192 16 0z"/></svg>'></asp:Label>
                            </asp:Panel>
                ...
                <GWC:FieldsetControl runat="server" ID="fsDetallesDocumentos" Label="Área de integración" Detail="Área de integración" CssClass="m-0 p-0" > 
                    <ListControls>
                        <asp:Panel runat="server" CssClass="row" ID="panelCarga">
                            ...
                            <asp:Panel runat="server" CssClass="col-lg-2 d-flex justify-content-end" ID="lbButtonXML" Visible="false">
                               <asp:Button  runat="server" Label="Procesar CFDI" CssClass="btn btn-procesamiento button btn-xml" Text='Procesar'/>
                            </asp:Panel>
                        </asp:Panel>

                        <asp:Panel runat="server" CssClass="row" >
                            <asp:Panel runat="server" CssClass="col-xs-12 col-md-12 col-lg-12" ID="areaDetalleDocumento" Visible="False">
                                <asp:Label runat="server" ID="lbDetalleDocumentosProcesados" Text="Documentos procesados"  CssClass="w-100 cl_Secciones mt-5" style="padding-left:28px"></asp:Label>
                                    <GWC:CatalogControl runat="server" ID="ccDocumentosProcesados" KeyField="indice" CssClass="w-100"  UserInteraction="false" CanSelect="true" CanAdd="false" CanClone="true" CanDelete="false" OnClick="ccDocumentosProcesados_Click">
                                        <Columns>
                                            <GWC:InputControl runat="server" Type="Text" ID="icNombreDocumento" Label="Documento" />
                                            <GWC:InputControl runat="server" Type="Text" ID="icFechaProceso" Label="Se procesó" />
                                            <GWC:InputControl runat="server" Type="Text" ID="icEmisor" Label="Emisor documento" />
                                            <GWC:InputControl runat="server" Type="Text" ID="icPorcentaje" Label="Confiabilidad" />
                                            <GWC:InputControl runat="server" Type="Text" ID="icEstatus" Label="Estado"/>
                                        </Columns>
                                    </GWC:CatalogControl>
                                </asp:Panel>
                        </asp:Panel>

                        <asp:Panel runat="server" CssClass="row mb-5" >
                             <asp:Panel runat="server" CssClass="col-lg-12 d-flex justify-content-end" ID="btnGenerarFactura" Visible="False">
                                  <asp:Button runat="server" Label="" Enabled="true" CssClass="btn button btn-generar-factura btn-procesamiento btn-generador" OnClick="btnGenerarPreasignacion_Click" Text="Generar factura"/>
                             </asp:Panel>
                        </asp:Panel>
                    </ListControls>
                </GWC:FieldsetControl>
