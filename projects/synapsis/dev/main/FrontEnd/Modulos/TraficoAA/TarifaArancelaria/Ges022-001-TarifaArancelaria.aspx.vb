...
#Region "██████ Vinculación c/capas inf █████████       SAX      ████████████████████████████████████████████"
    ...
    Public Overrides Sub Inicializa()
        ...
        If Not Page.IsPostBack Then
            ...
            cctlcan.DataSource = Nothing

            cctlcue.DataSource = Nothing

        Else

            cctlcan.DataSource = Session("catTLCAN")
            cctlcue.DataSource = Session("catTLCUE")
                    ...
                    With paises.Partida(indice2_)
                        ...
                        If tratado = "TLCAN" Then
                            ...
                            catTLCAN.Add(New Dictionary(Of String, String) From {
                               {"indice", indice2_},
                               {"icPaisesTab1", .Attribute(CamposTarifaArancelaria.CA_PAIS).Valor},
                               {"icSectorTab1", ""},
                               {"icArancelTab1", .Attribute(CA_ARANCEL).Valor},
                               {"icObservacionTab1", .Attribute(CA_OBSERVACION).Valor},
                               {"icPublicacionTab1", .Attribute(CA_FECHA_PUBLICACION).Valor},
                               {"icEntradaVigorTab1", .Attribute(CA_FECHA_ENTRADA_VIGOR).Valor}
                           })
                        ...
                        If tratado = "TLCUE" Then
                            ...
                            catTLCUE.Add(New Dictionary(Of String, String) From {
                               {"indice", indice2_},
                               {"icPaisesTab2", .Attribute(CamposTarifaArancelaria.CA_PAIS).Valor},
                               {"icSectorTab2", ""},
                               {"icArancelTab2", .Attribute(CA_ARANCEL).Valor},
                               {"icObservacionTab2", .Attribute(CA_OBSERVACION).Valor},
                               {"icPublicacionTab2", .Attribute(CA_FECHA_PUBLICACION).Valor},
                               {"icEntradaVigorTab2", .Attribute(CA_FECHA_ENTRADA_VIGOR).Valor}
                           })
