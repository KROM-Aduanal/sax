	...
	constructor() {
  	...
  	connectedCallback() {
            ...
            this._component.addEventListener('input', function () {
                ...
                const keywords_ = ['AHORA', 'ASIGNAR', 'BUSCARDICCIONARIO','BUSCARV', 'COINCIDIR', 'CONCATENAR', 'DENTRO', 'DICCIONARIO',
                                   'ENLISTAR', 'ESBLANCO','ESPACIOS', 'EXTRAE', 'HOY', 'LARGO' , 'NO', 'O', 'RANGO', 'RED', 'REDONDEAR',
